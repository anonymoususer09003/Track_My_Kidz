    ...
    <>
      <View style={styles.layout}>
        <View style={[styles.mainLayout, {paddingHorizontal: 20}]}>
          <Card
            ...
            header={
              <Header
                title={
                  subscriptionType.type === 'product-activation'
                    ? 'Product Listing'
                    : 'Scheduler'
                }
              />
            ...
            <RadioOptions
              switchOption={setOption}
              annual={
                subscriptionType.type === 'product-activation'
                  ? annualProductListing
                  : annualServiceActivation
              }
              monthly={
                subscriptionType.type === 'product-activation'
                  ? monthlyProductListing
                  : monthlyServiceActivation
              }
            />
          </Card>
        ...
        <View style={styles.buttonsContainer}>
          <View style={[styles.background, !isValid && {opacity: 0.5}]}>
            <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            <Text style={styles.buttonOutline}>Cancel</Text>
          </TouchableOpacity>
        </View>
      </View>
    </>
