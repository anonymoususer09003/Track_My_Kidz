                    ...
                    <View style={styles.layout}>
                        <View style={styles.mainLayout}>
                            <Formik
                                ...
                                initialValues={{ facebook: user?.fbAccount || '', instagram: user?.instagramAccount || '', twitter: user?.twitterAccount || '', website: user?.websiteUrl || '' }}
                            ...
                            >
                                {({
                                    ...
                                    <>
                                        ...
                                        {isSending ? (isSent ? <View style={styles.sppinerContainer}>
                                            <Text style={styles.sent}>User updated!</Text>
                                        </View> : <View style={styles.sppinerContainer}>
                                            <Spinner status='primary' />
                                        </View>) : <Layout style={styles.formContainer}>
                                            <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                                ...
                                                {isEditMode ? <Input
                                                    style={{ marginTop: 20, width: '75%', backgroundColor: Colors.white }}
                                                    textStyle={{ color: Colors.primary }}
                                                    placeholderTextColor={'#9DD5D3'}
                                                    onChangeText={handleChange('facebook')}
                                                    value={values.facebook}

                                                    placeholder={values.instagram === '' ? "Facebook username" : null}
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                                ...
                                                {isEditMode ? <Input
                                                    ...
                                                    textStyle={{ color: Colors.primary }}
                                                    placeholderTextColor={'#9DD5D3'}
                                                    placeholder={values.instagram === '' ? "Instagram username" : null}
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                                ...
                                                {isEditMode ? <Input
                                                    ...
                                                    placeholder={values.twitter === '' ? "Twitter username" : null}
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                                ...
                                                {isEditMode ? <Input
                                                    ...
                                                    placeholder={values.website === '' ? "Website URL" : null}
