...
import { StyleSheet, View, TouchableWithoutFeedback, ScrollView, Alert, TouchableOpacity, } from 'react-native'
import { useTheme } from '@/Theme'
import { Text, Icon, Input, Spinner } from '@ui-kitten/components';
import { loadUserId } from '@/Storage/MainAppStorage'
import { StartPasswordChange, UpdateUser, VerifyPasswordChange } from '../../../Services/SettingsServies'
...
const ChangePasswordScreen = () => {
    ...
    return (
        <>
            <AppHeader title="Change Password" isBack />
            {
                isLoading ? <View style={styles.sppinerContainer}>
                    ...
                    <ScrollView style={styles.container}>
                        <View style={[[Layout.column, Layout.justifyContentCenter]]}>
                            <Formik
                                ...
                                initialValues={{ oldPassword: "", password: "", newPassword: "", verificationCode: "" }}
                            ...
                            >
                                {({
                                    ...
                                    <>
                                        {isSending ? <View style={styles.sppinerContainer}>
                                            <Spinner status='primary' />
                                        </View> :
                                            <>
                                                <View style={styles.inputSettings}>
                                                    <Input
                                                        ...
                                                        label={evaProps => <Text {...evaProps} style={{ fontSize: 16 }}>Old password</Text>}
                                                ...
                                                <View style={styles.inputSettings}>
                                                    <Input
                                                        ...
                                                        label={evaProps => <Text {...evaProps} style={{ fontSize: 16 }}>New password</Text>}
                                                ...
                                                <View style={styles.inputSettings}>
                                                    ...
                                                    <Input
                                                        ...
                                                        label={evaProps => <Text {...evaProps} style={{ fontSize: 16 }}>Confirm new password</Text>}
                                                ...
                                                <View style={styles.inputSettings}>
                                                    <Input
                                                        ...
                                                        textStyle={{ fontSize: 16 }}
                                                        autoCapitalize='none'
                                                        label={evaProps => <Text {...evaProps} style={{ fontSize: 16 }}>Activation code</Text>}
...
const styles = StyleSheet.create({
    ...
    editLabel: { fontSize: 12, color: 'rgba(143, 155, 179, 0.48)', marginBottom: 4, marginTop: 8, }
})
