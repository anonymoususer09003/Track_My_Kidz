...
const InstructorGroupDeclineScreen = ({ route }) => {
        ...
        <>
            <View style={styles.layout}>
                ...
                <View style={{ marginVertical: 5 }}>
                    <Text style={{ textAlign: 'center' }}>Select student/s and click "Resend Request Permission" button to request permission from parents.</Text>
                </View>
