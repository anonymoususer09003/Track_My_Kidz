...
import { Input, Layout, Button, Select, SelectItem, Toggle } from '@ui-kitten/components';
...
import { DeleteInstructor, UpdateMultipleInstructor } from '@/Services/Instructor';
...
const EditOrgInstructorsModal = ({
  ...
  return (
    <Modal
      ...
      swipeDirection="down"
      onSwipeComplete={() => {
        dispatch(ChangeModalState.action({ addInstructorModalVisibility: false }));
      }}
      onBackdropPress={() => {
        dispatch(ChangeModalState.action({ addInstructorModalVisibility: false }));
      }}
    ...
    >
      <>
        ...
        >
          <Text style={[{ textAlign: 'center', marginVertical: 30, fontSize: 18 }]}>
            ...
            {({
              ...
              <>
                <Input
                  ...
                  label={(evaProps: any) => <Text style={styles.inputLabels}>First Name</Text>}
                />
                ...
                <Input
                  ...
                  label={(evaProps: any) => <Text style={styles.inputLabels}>Last Name</Text>}
                />
                ...
                <Input
                  ...
                  label={(evaProps: any) => <Text style={styles.inputLabels}>Email</Text>}
                />
                ...
                <Input
                  ...
                  label={(evaProps: any) => <Text style={styles.inputLabels}>Phone</Text>}
                />
                ...
                >
                  <Text style={[styles.inputLabels, { margin: 10 }]}>Admin</Text>
                  <Toggle
                ...
                <View style={{ marginTop: 40, width: '100%', alignItems: 'center' }}>
                  ...
                  {isEdit && (
                    <LinearGradientButton onPress={handleDelete}>Delete</LinearGradientButton>
                  )}
