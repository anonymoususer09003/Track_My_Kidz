...
import {
    FavouritePostsScreen, ContributorScreen, UserProfile, UserBlogsScreen, CommentsScreen, ReplyCommentScreen
} from '@/Screens'
...
const ContributorStack = () => (
    <ContributorNavigatior.Navigator
        initialRouteName="FavouritePostsScreen"
    >
        <ContributorNavigatior.Screen name="HomeScreen" component={FavouritePostsScreen} options={{ headerShown: false }} />
