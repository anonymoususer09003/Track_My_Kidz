...
import {
    CommentsScreen, ReplyCommentScreen, MyPostsScreen, FollowersScreen, FollowingScreen
} from '@/Screens'
...
const MyPostsStack = () => (
    ...
    >
        ...
        <MyPostsNavigator.Screen name="ContributorFollowersScreen" component={FollowersScreen} options={{ header: ({ navigation }) => (<AuthStackHeader navigation={navigation} title="Followers" back={true} />) }} />
        <MyPostsNavigator.Screen name="ContributorFollowingScreen" component={FollowingScreen} options={{ header: ({ navigation }) => (<AuthStackHeader navigation={navigation} title="Following" back={true} />) }} />
    </MyPostsNavigator.Navigator>
)
